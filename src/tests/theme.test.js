...
describe('theme', () => {
	...
	it('Component overrides are correct', () => {
		...
		const firstComponentOveriding = componentOveriding[Object.keys(componentOveriding)[0]]
		console.log(firstComponentOveriding)
		const areOverrideOptionsCorrect = Object.keys(firstComponentOveriding).every(
			el => el === 'styleOverrides' || el === 'defaultProps'
		)
